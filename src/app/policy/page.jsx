...
export default function Policy() {
  return (
    ...
    <p>
      1.1	Data controller.<br />
      This Privacy Statement, as amended or otherwise changed from time to time (the &quot;Privacy Statement&quot;), explains the manner in which CRYPTOSPACE (&quot;CS&quot;, &quot;We&quot;, &quot;Us&quot;, &quot;Our&quot;) collects, uses, maintains and discloses Personal Data through the provision of Our App &quot;Cryptopay&quot; and Our other services (the &quot;Services&quot;). CS is the Data Controller of your Personal Data.
    </p> 
    <p>
      1.2	CS is authorized and regulated by the Financial Crimes Enforcement Network Department of the Treasury  (the &quot;FINCENT&quot;).
    </p>
    <p>
      1.3	CS&quot;S registered address is: 1379 Park Western Dr San Pedro CA 90732.  
    </p>    
    <p>
      1.4	CS is registered with number 31000230427551 as a MSB from FINCENT .
    </p>    
    <p>
    ...
    <p>
      1.7	&quot;Processing&quot; means any operation or set of operations which is performed upon Personal Data, whether or not by automatic means, such as collection, recording, organization, storage, adaptation or alteration, retrieval, consultation, use, disclosure by transmission, dissemination or otherwise making available, alignment or combination, blocking, erasure or destruction, and &quot;Processed&quot;, &quot;Processes&quot; and &quot;Process&quot; shall be construed accordingly.
    </p>    
    <p>
    ...
    <p>
        (a)	Processed fairly, lawfully and securely;<br />
        (b)	for specified, explicit and legitimate purposes in accordance with the Data Subject&quot;s rights and not further Processed in a way incompatible with those purposes or rights; and that it is<br />
        (c)	adequate, relevant and not excessive in relation to the purposes for which they were collected or further processed;<br />
        (d)	accurate and, where necessary, kept up to date; and<br />
        (e)	kept in a form which permits identification of Data Subjects for no longer than is necessary for the purposes for which the Personal Data were collected or for which they are further Processed.<br />
    </p>    
    <p>
    ...
    <p>
      1.10	Data Protection Officer (&quot;DPO&quot;) You may contact Our DPO by email at Info@CSapp.com  
    </p>    
    <p>
      1.11	ADGM Supervisory Authority<br />
      We are registered as a Money Service Business with Financial Crimes Enforcement Network Department of the Treasury (https://bsaefiling1.fincen.treas.gov/BSALoginMain).<br />
      Other Supervisory Authorities  Although We are based in, and operate from, the USA we offer Our Services globally.<br /> 
    </p>    
    <p>
    ...
    <p>
      ...
      (c)	Contact details (telephone number, email address);<br />
      (d)	Date and place of birth, place of citizenship, country of residence;<br />
      (e)	Bank account information and/or credit card details;<br />
      (f)	Your status as a politically exposed person;<br />
      (g)	Source of funds & proof of residence;<br />
      (h)	Passport and/or national driver’s license or government-issued identification card to verify your identity;<br />
      (i)	Second nationality and Passport, if applicable;<br />
      (j)	Selfie;<br />
      (k)	Transaction history and account balances in connection with your use of Our Services.<br />
    </p>    
    <p>
    ...
    <p>
      3.3.2	We use cookies to collect information. &quot;Cookies&quot; are small pieces of information that a website sends to your computer’s hard drive while you are viewing the website.
    </p>    
    <p>
    ...
    <p>
      4.4.3 Processing relates to Personal Data which are manifestly made public by the Data Subject, or is necessary for the establishment, exercise or defense of legal claims;
    </p>
    <p>
    ...
    <p>
      6.1.3 Opting out: you can ask Us or third parties to stop sending you marketing messages at any time by following the opt-out links on any marketing message sent to you or by contacting Us via Our DPO info@CSapp.com 
    </p>
    <p>
    ...
    <p>
      8.5 Please contact Us via our email info@CSapp.com if you want further information on the specific mechanism used by Us when transferring your Personal Data out of ADGM.
    </p>
    <p>
    ...
    <p>
      You can update your information by contacting Us via Our email info@CSapp.com  and making a request.
    </p>
    <p>
    ...
    <p>
      13.1 We take the protection of your Personal Data seriously, and We apply appropriate physical, technological and organizational safeguards and security measures. We use industry-standard data encryption technology and have implemented restrictions related to the storage of and the ability to access your Personal Data. Our servers and business operations are entirely located in ADGM.
    </p>
    <p>
      13.2 Where Processing is carried out by any Third Party on our behalf, We require from that Third Party sufficient guarantees in respect of the technical security measures and organizational measures governing the Processing to be carried out, and We ensure compliance with those measures.
    </p>
    <p>
    ...
    <p>
      We may need to request specific iformation from you to help Us confirm your identity and ensure your rights to access your Personal Data (or to exercise any of your other rights). This is a security measure to ensure that Personal Data is not disclosed to any person who has no right to receive it. We may also contact you to ask you for further information in relation to your request to speed up Our response.
    </p>
    <p>
    ...
    <p>
      18.1 Any questions about this Privacy Policy, the collection, use and disclosure of Personal Data by Us or access to your Personal Data as required by law (to be disclosed should be directed to  info@CSapp.com
    </p>
    <p>
